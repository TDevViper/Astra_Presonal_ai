...
_MODE_ALIASES = {
    "casual":"chill", "relaxed":"chill", "chill":"chill",
    "focus":"focus", "focused":"focus", "work":"focus",
    "jarvis":"jarvis", "default":"jarvis", "normal":"jarvis",
    "expert":"expert", "phd":"expert", "advanced":"expert",
    "debug":"debug", "engineer":"debug",
}
...
def switch_mode():
    try:
        ...
        return jsonify({"error": f"Unknown mode: '{raw}'", "valid_modes": sorted(_MODE_ALIASES.keys())}), 400
    except Exception as e:
        return jsonify({"error": str(e)}), 500
