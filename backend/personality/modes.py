...
MODES: Dict[str, Dict] = {
    "jarvis": {
        "name": "JARVIS",
        "description": "Default — sharp, direct, dry wit",
        "token_budget": {
            "casual": 200,
            "technical": 500,
            "coding": 600,
    ...
    "focus": {
        "name": "FOCUS",
        "description": "Deep work — no small talk, long technical replies",
        "token_budget": {
            "casual": 100,
            "technical": 800,
            "coding": 900,
    ...
    "debug": {
        "name": "DEBUG",
        "description": "Engineering mode — diagnose everything",
        "token_budget": {
            "casual": 200,
            "technical": 700,
            "coding": 900,
...
MODE_TRIGGERS = {
    ...
    "debug mode": "debug",
    "jarvis mode": "jarvis",
    "switch to focus": "focus",
    "switch to chill": "chill",
...
def get_tts_config() -> Dict:
    cfg = get_mode_config()
    return {
        "speed": cfg.get("tts_speed", 1.1),
        "voice": cfg.get("tts_voice", "af_bella"),
    }
